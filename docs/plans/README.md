...
| [4.1](phase-4.1-partis-scores.md) | Corrections des scores relevées à la revue de la phase 4 | ✔️ terminé |
...
```
0 socle ──► 0.1 corrections ──► 1 ingestion ──► 2 pages publiques ──► 2.1 corrections
                  │
